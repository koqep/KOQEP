...
**M7a TAMAMEN KAPANDI (2026-08-19), M0-M6 TAMAMLANDI.** M7b (cila) — Slice E/H2/D2/I2 TAMAMLANDI ve MERGE OLDU (PR #68-71). Kalan tek dilim: D1 (rate limit, Faz 1 trafiği bekliyor) — milestone TAMAMEN KAPANMADI. **M6c (mesaj içeriği anonimleştirme) TÜM dilimleri TAMAMLANDI VE main'e MERGE OLDU (PR #73-76) — milestone KAPANDI. M6b (5651 trafik logu): Slice A (proxy/IP + rate-limit) TAMAMLANDI VE MERGE OLDU (PR #77-78); Slice B (`TrafficLog` şeması) TAMAMLANDI, push onayında; Slice C-G henüz başlamadı.** Detaylar `docs/milestones/M7b-scale-polish.md`, `docs/milestones/M6b-traffic-log-5651.md`.
...
- **Görev:** `chore/remove-xff-verify-log` MERGE OLDU (PR #79) — geçici `[M6B-XFF-VERIFY]` log'u main.ts'ten kalktı. Kalan tek push: `m6b/slice-b-traffic-log-schema` (şema+migration+doküman commit'leri), kullanıcı onayında.
- **Sonraki adım:** M6b Slice C (REST middleware) — önce Postgres depolama kapasitesi kararı (A18) alınmalı, sonra kendi plan-modu turuyla başlar. Senaryo A/B (nitelikli zaman damgası) kararı hâlâ bekliyor. D1 (rate limit) Faz 1 gerçek trafiğini bekliyor.
