  ...
  return (
    <main lang="en" className="animate-fade-in mx-auto max-w-2xl p-4 text-neutral-400">
      ...
      <div className="flex flex-col gap-4">
        <p>
          This page stands in for the real privacy policy, which will explain
          what data KOQEP collects, why, how long it is retained, and users&apos;
          rights (including deletion and export). The text will be written
          here once the legal review under Turkish law (5651/KVKK) is
          complete.
        </p>
        <p>
